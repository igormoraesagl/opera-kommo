# Kommo CRM · conector do OPERA

Liga o **Kommo CRM** ao Claude. Depois de instalado, você pergunta em português e
o Claude responde olhando o dado real: leads, funis, tarefas e relatórios do seu CRM.

## Instalar em um clique

[![Deploy to Cloudflare](https://deploy.workers.cloudflare.com/button)](https://deploy.workers.cloudflare.com/?url=https://github.com/igormoraesagl/opera-kommo)
...
fala direto com o seu Worker, e o seu Worker fala direto com o Kommo CRM.
